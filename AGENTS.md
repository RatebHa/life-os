# AGENTS.md — Life OS Project Intelligence

This file is the single source of truth for Codex working on this project.
...
│   │   ├── ai-xp.ts          # Codex Haiku XP scorer + fallback logic
